...
const InputBar = ({ value, onChange , onSearch, isFetching }) => {
 ...
 const handleSearchClicked=()=>{
  ...
  return (
    ...
    <div className="flex flex-column w-full h-16  duration-150 border rounded  hover:border-zinc-100/80 border-zinc-600 focus-within:border-zinc-100/80 focus-within:ring-0 ">
        ...
        <label htmlFor="uploads_btn" className="sr-only" />
            ...
            role="button" 
            id="uploads_btn" 
            className="w-full h-full py-0 bg-transparent border-0 border-transparent rounded text-zinc-500 focus:ring-0 sm:text-sm text-center"
            onClick={handleSearchClicked}
            disabled={isFetching}>
            {isFetching ? <svg aria-hidden="true" role="status" className="inline w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
